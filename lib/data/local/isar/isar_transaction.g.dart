...
IsarTransaction _isarTransactionDeserialize(
  ...
  object.payment = reader.readString(offsets[6]);
  object.type =
      _IsarTransactiontypeValueEnumMap[reader.readByteOrNull(offsets[7])] ??
...
extension IsarTransactionQuerySortBy
  ...
  QueryBuilder<IsarTransaction, IsarTransaction, QAfterSortBy> sortByClient() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarTransaction, IsarTransaction, QAfterSortBy> sortByGroupId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarTransaction, IsarTransaction, QAfterSortBy> sortByMemo() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarTransaction, IsarTransaction, QAfterSortBy> sortByPayment() {
    return QueryBuilder.apply(this, (query) {
...
extension IsarTransactionQuerySortThenBy
  ...
  QueryBuilder<IsarTransaction, IsarTransaction, QAfterSortBy> thenByClient() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'client', Sort.asc);
    });
  }
  ...
  QueryBuilder<IsarTransaction, IsarTransaction, QAfterSortBy> thenByGroupId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'groupId', Sort.asc);
    });
  }
  ...
  QueryBuilder<IsarTransaction, IsarTransaction, QAfterSortBy> thenByMemo() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'memo', Sort.asc);
    });
  }
  ...
  QueryBuilder<IsarTransaction, IsarTransaction, QAfterSortBy> thenByPayment() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'payment', Sort.asc);
    });
  }
...
extension IsarTransactionQueryWhereDistinct
  ...
  QueryBuilder<IsarTransaction, IsarTransaction, QDistinct> distinctByClient(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarTransaction, IsarTransaction, QDistinct> distinctByMemo(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarTransaction, IsarTransaction, QDistinct> distinctByPayment(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension IsarTransactionQueryProperty
  ...
  QueryBuilder<IsarTransaction, int, QQueryOperations> categoryIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'categoryId');
    });
  }

  QueryBuilder<IsarTransaction, String, QQueryOperations> clientProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'client');
    });
  }

  QueryBuilder<IsarTransaction, DateTime, QQueryOperations> dateTimeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'dateTime');
    });
  }

  QueryBuilder<IsarTransaction, int?, QQueryOperations> groupIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'groupId');
    });
  }

  QueryBuilder<IsarTransaction, String, QQueryOperations> memoProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'memo');
    });
  }

  QueryBuilder<IsarTransaction, String, QQueryOperations> paymentProperty() {
    return QueryBuilder.apply(this, (query) {
