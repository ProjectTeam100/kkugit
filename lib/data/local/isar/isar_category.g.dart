...
const IsarCategorySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'type': PropertySchema(
      ...
      name: r'type',
      type: IsarType.byte,
      enumMap: _IsarCategorytypeEnumValueMap,
    )
  },
...
IsarCategory _isarCategoryDeserialize(
  ...
  object.type =
      _IsarCategorytypeValueEnumMap[reader.readByteOrNull(offsets[1])] ??
          CategoryType.income;
  return object;
}
...
P _isarCategoryDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_IsarCategorytypeValueEnumMap[reader.readByteOrNull(offset)] ??
...
const _IsarCategorytypeEnumValueMap = {
  'income': 0,
  'expense': 1,
};
const _IsarCategorytypeValueEnumMap = {
...
extension IsarCategoryQueryProperty
  ...
  QueryBuilder<IsarCategory, CategoryType, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
