...
const IsarGroupSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'type': PropertySchema(
      ...
      name: r'type',
      type: IsarType.byte,
      enumMap: _IsarGrouptypeEnumValueMap,
    )
  },
...
IsarGroup _isarGroupDeserialize(
  ...
  object.type = _IsarGrouptypeValueEnumMap[reader.readByteOrNull(offsets[1])] ??
      GroupType.income;
  return object;
}
...
P _isarGroupDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_IsarGrouptypeValueEnumMap[reader.readByteOrNull(offset)] ??
          GroupType.income) as P;
    default:
      throw IsarError('Unknown property with id $propertyId');
  }
}

const _IsarGrouptypeEnumValueMap = {
  'income': 0,
  'expense': 1,
};
const _IsarGrouptypeValueEnumMap = {
  0: GroupType.income,
  1: GroupType.expense,
};
...
extension IsarGroupQueryWhereSort
  ...
  QueryBuilder<IsarGroup, IsarGroup, QAfterWhere> anyId() {
...
extension IsarGroupQueryWhere
  ...
  QueryBuilder<IsarGroup, IsarGroup, QAfterWhereClause> idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarGroup, IsarGroup, QAfterWhereClause> idNotEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarGroup, IsarGroup, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarGroup, IsarGroup, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<IsarGroup, IsarGroup, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
...
extension IsarGroupQueryFilter
  ...
  QueryBuilder<IsarGroup, IsarGroup, QAfterFilterCondition> typeEqualTo(
      GroupType value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'type',
  ...
  QueryBuilder<IsarGroup, IsarGroup, QAfterFilterCondition> typeGreaterThan(
    GroupType value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarGroup, IsarGroup, QAfterFilterCondition> typeLessThan(
    GroupType value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarGroup, IsarGroup, QAfterFilterCondition> typeBetween(
    GroupType lower,
    GroupType upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension IsarGroupQuerySortBy on QueryBuilder<IsarGroup, IsarGroup, QSortBy> {
  ...
  QueryBuilder<IsarGroup, IsarGroup, QAfterSortBy> sortByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<IsarGroup, IsarGroup, QAfterSortBy> sortByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension IsarGroupQuerySortThenBy
  ...
  QueryBuilder<IsarGroup, IsarGroup, QAfterSortBy> thenByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<IsarGroup, IsarGroup, QAfterSortBy> thenByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }
...
extension IsarGroupQueryWhereDistinct
  ...
  QueryBuilder<IsarGroup, IsarGroup, QDistinct> distinctByType() {
    return QueryBuilder.apply(this, (query) {
...
extension IsarGroupQueryProperty
  ...
  QueryBuilder<IsarGroup, GroupType, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
